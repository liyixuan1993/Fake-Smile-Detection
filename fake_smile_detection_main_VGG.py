...
with tf.name_scope("conv12"):
    conv12 = tf.layers.conv2d(conv11, filters=conv12_fmaps, kernel_size=conv12_ksize,
                         strides=conv12_stride, padding=conv12_pad,
...
with tf.name_scope("conv33"):
    conv33 = tf.layers.conv2d(conv32, filters=conv33_fmaps, kernel_size=conv33_ksize,
                         strides=conv33_stride, padding=conv33_pad,
                         activation=tf.nn.relu, name="conv33")
...
with tf.name_scope("conv43"):
    conv43 = tf.layers.conv2d(conv42, filters=conv43_fmaps, kernel_size=conv43_ksize,
                         strides=conv43_stride, padding=conv43_pad,
                         activation=tf.nn.relu, name="conv43")
...
with tf.name_scope("conv53"):
    conv53 = tf.layers.conv2d(conv52, filters=conv53_fmaps, kernel_size=conv53_ksize,
                         strides=conv53_stride, padding=conv53_pad,
                         activation=tf.nn.relu, name="conv53")    
